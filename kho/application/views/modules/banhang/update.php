    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
          ...
          <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <?php foreach($row as $k=>$v): ?>
              <option value="<?=$k?>" <?php echo ($k==$r->category_id)?'selected':'' ?>><?=$v?></option>
            <?php endforeach; ?>
            </select>
          </div>
        </div>
      ...
      <div class="col-md-6 col-xs-12">
        <div class="form-group">
          ...
          <div class="col-md-9 col-sm-9 col-xs-12">
            <input id="hinh" name="avatar" type="text" size="60" value="<?php echo set_value('avatar')?set_value('avatar'):$r->image?>" />
            <input type="button" value="Browse Server" onclick="BrowseServer( 'Images:/', 'hinh' );" />
            <p><small>File types hợp lệ: png, jpg, gif.</small></p>
             <?php echo isset($r->image)?'<img src="'.$r->image.'" width="50" height="50">':'' ?>
          </div>
        </div>
      </div>
      <div class="col-md-12">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <textarea class="form-control" rows="5" placeholder="Ghi chú" name="note"><?php echo (set_value('note'))?set_value('note'):$r->note; ?></textarea>
        </div>
      </div>
