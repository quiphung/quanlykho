    ...
    <div class="col-md-12">
      ...
      <div class="form-group name">
        ...
        <div class="col-md-10 col-sm-10 col-xs-12">
          <input type="text" class="form-control" name="name" value="<?php echo (set_value('name'))?set_value('name'):$r->title; ?>">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-10 col-sm-10 col-xs-12">
          ...
          <?php foreach($row as $k=>$v): ?>
            <option value="<?=$k?>" <?php echo ($r->parent_id==$k)?'selected':'' ?>><?=$v?></option>
          <?php endforeach; ?>
          </select>
        </div>
      </div>
